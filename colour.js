...
var hexToRGB = Colour.hexToRGB = function (hex) {
...
var cssRGBToRGB = Colour.cssRGBToRGB = function (css) {
...
var rgbToCSSRGB = Colour.rgbToCSSRGB = function (rgb) {
    return "rgb" + (rgb.a?"a":"") + "(" +
        round(rgb.r) + ", " +
        round(rgb.g) + ", " +
        round(rgb.b) +
...
var hslToCSSHSL = Colour.hslToCSSHSL = function (hsl) {
    return "hsl" + (hsl.a?"a":"") + "(" +
        round(hsl.h * 360) + ", " +
        round(hsl.s * 100) + "%, " +
        round(hsl.l * 100) + "%" +
...
var cssHSLToHSL = Colour.cssHSLToHSL = function (css) {
...
var rgbToHex = Colour.rgbToHex = function (rgb) {
    var alpha,
        str = "#" +
...
var rgbToHSL = Colour.rgbToHSL = function (rgb) {
    var v, m, vm, r2, g2, b2,
        r = rgb.r/255,
        g = rgb.g/255,
        b = rgb.b/255,
...
var hslToRGB = Colour.hslToRGB = function (hsl) {
