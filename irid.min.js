...
return new Irid({h:(this.hsl.h+.5)%1,s:this.hsl.s,l:this.hsl.l,a:this.hsl.a})},desaturate:function(){this._makeHSL();return new Irid({h:this.hsl.h,s:0,l:this.hsl.l,a:this.hsl.a})},contrast:function(a,b){a=Irid(a||"#fff");b=Irid(b||"#000");var c=Math.abs(a.luma()-this.luma()),e=Math.abs(b.luma()-this.luma());return c>e?a:b},analagous:function(){return[this,this.hue(this.hue()-1/12),this.hue(this.hue()+1/12)]},tetrad:function(){var a=this.hue();return[this,this.hue(a+.25),this.hue(a+.5),this.hue(a+
.75)]},rectTetrad:function(){return[this,this.hue(this.hue()+1/6),this.hue(this.hue()+.5),this.hue(this.hue()+4/6)]},triad:function(){return[this,this.hue(this.hue()-1/3),this.hue(this.hue()+1/3)]},splitComplementary:function(){return[this,this.hue(this.hue()-5/12),this.hue(this.hue()+5/12)]},blend:function(a,b){"undefined"==typeof b&&(b=.5);var c=1-b;a=new Irid(a);return new Irid({r:Math.floor(this.red()*c+a.red()*b),g:Math.floor(this.green()*c+a.green()*b),b:Math.floor(this.blue()*c+a.blue()*b)})},
toString:function(){return this.toHexString()},toHexString:function(){this._makeRGB();return rgbToHex(this.rgb)},toRGBString:function(){this._makeRGB();return rgbToCSSRGB(this.rgb)},toHSLString:function(){this._makeHSL();return hslToCSSHSL(this.hsl)}};
