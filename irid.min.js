...
Irid.canInterpret=function(a){return a&&(a instanceof Irid||void 0!==a.h&&void 0!==a.s&&void 0!==a.l||"string"==typeof a&&(hexToRGB(a)||cssRGBToRGB(a)||hexToRGB(Irid.swatches[a.toLowerCase()]))||void 0!==a.r&&void 0!==a.g&&void 0!==a.b)};
...
s:parseSLValue(a[2]),l:parseSLValue(a[3]),a:parseAlphaValue(a[4])}:void 0},rgbToHex=Irid.rgbToHex=function(a){var b="#"+(16>a.r?"0":"")+a.r.toString(16)+(16>a.g?"0":"")+a.g.toString(16)+(16>a.b?"0":"")+a.b.toString(16);void 0!==a.a&&(a=floor(255*a.a),b+=(16>a?"0":"")+a.toString(16));return b},rgbToHSL=Irid.rgbToHSL=function(a){var b,c,f,g,d,h=a.r/255,k=a.g/255,e=a.b/255,l=g=0,m=0;b=max(h,k,e);c=min(h,k,e);m=(c+b)/2;0<m&&(l=f=b-c,0<l&&(l/=.5>=m?b+c:2-b-c,g=(b-h)/f,d=(b-k)/f,f=(b-e)/f,g=(h==b?k==c?
5+f:1-d:k==b?e==c?1+g:3-f:h==c?3+d:5-g)/6));return{h:g%1,s:l,l:m,a:a.a}},hslToRGB=Irid.hslToRGB=function(a){var b,c,f,g,d,h,k,e;e=a.h%1;b=a.s;d=a.l;0>e&&(e+=1);c=f=g=d;b=.5>=d?d*(1+b):d+b-d*b;if(0<b)switch(d=d+d-b,h=(b-d)/b,e*=6,k=floor(e),h=b*h*(e-k),e=d+h,h=b-h,k){case 0:c=b;f=e;g=d;break;case 1:c=h;f=b;g=d;break;case 2:c=d;f=b;g=e;break;case 3:c=d;f=h;g=b;break;case 4:c=e;f=d;g=b;break;case 5:c=b,f=d,g=h}return{r:floor(255*c),g:floor(255*f),b:floor(255*g),a:a.a}};
